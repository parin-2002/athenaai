...
class PromptTemplates:
    ...
    def quiz_generation_prompt_template():
        ...
        #  Focus these questions within the domain of Artificial Intelligence. 
        #  Ensure that the correct answer for each question is randomly distributed across the options (A, B, C, D) and include a variety of question and scenario-based. 
        #  Each question should cover different subtopics or concepts within Artificial Intelligence to ensure content variety. 
        #  Make sure the questions are not repeated and check all the questions to be conforming the text as well.
        #  Focus these questions within the domain of Artificial Intelligence and Data science.
        #  After presenting all the questions, list the answer followed by detailed explanations. 
        #  The explanations should provide a detailed justification for the correct answer, referencing relevant AI principles and theories, and include an example for clarity.
...
# prompt = question_answer_template.generate_prompt(context="Context", question="Question")
...
#         """
#         prompt_template = f"""
#         You are an AI teaching assistant designed to help students understand course material. 
#         Your role is to provide clear, concise explanations tailored to the student's level of understanding based on the notes provided as context.
#         Do not answer questions if they are not relevant to the context or discussion.
#         Break down complex topics into easy-to-understand steps.
#         Use examples and analogies to illustrate points.
...
#         """
#         prompt_template = f"""
#         Answer the question effectively for students and make sure to answer questions from the provided context including your knowledge.
#         Do not answer questions if they are not relevant to the context or discussion.
#         Use examples as well to explain.
#         Say thanks at the end.
